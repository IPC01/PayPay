        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white">
          <div>
            ...
            <p className="text-lg text-white/90 mb-8">
              Crie sua conta e comece a aproveitar todos os benefícios da nossa plataforma.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="font-semibold">Cadastro simples</p>
                <p className="text-sm text-white/80">Processo rápido e intuitivo</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/80">Verificação em duas etapas</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="font-semibold">Acesso global</p>
                <p className="text-sm text-white/80">Disponível em qualquer dispositivo</p>
              </div>
            </div>
          </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-brand-700 mt-1">
                        Insira o código enviado para o seu telemóvel ou email.
                      </p>
