...
const PAGE_TITLES = [
  { path: '/client/transactions/c2b-test', label: 'C2B teste' },
  { path: '/client/transactions/c2b', label: 'C2B' },
  { path: '/client/transactions/b2c', label: 'B2C' },
  { path: '/client/transactions', label: 'Transações' },
  { path: '/client/wallets', label: 'Carteiras' },
  { path: '/client/withdrawals', label: 'Saques' },
  { path: '/client/tokens', label: 'Chaves de Acesso' },
  { path: '/client/tickets', label: 'Tickets' },
  { path: '/client/packages', label: 'Pacotes' },
  { path: '/client/kyc', label: 'KYC' },
  { path: '/client/legal', label: 'Legais' },
  { path: '/client/profile', label: 'Meu Perfil' },
  { path: '/client/notifications', label: 'Notificações' },
        ...
        <div className="flex min-w-0 flex-1 items-center justify-end gap-2">
          {kycStatus !== 'APPROVED' && (
            <button
              ...
              className="hidden min-w-0 items-center gap-2 rounded-full border border-red-200 bg-red-50 px-3 py-2 text-red-700 shadow-sm animate-pulse transition-all duration-200 hover:bg-red-100 md:inline-flex"
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              ...
              <span className="hidden text-left sm:block">
                <span className="block text-sm font-medium text-gray-900">{user?.name?.split(' ')[0] || 'Usuário'}</span>
