      ...
      <div className="mx-auto flex max-w-none items-center gap-3 px-3 py-2 sm:px-4">
        <div className="flex shrink-0 items-center gap-3">
          <div>
            ...
            <h1 className="text-lg font-semibold text-slate-900 dark:text-white">{settings?.platformName || 'Painel Administrativo'}</h1>
          </div>
        </div>
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              ...
              <span className="hidden text-left sm:block">
                <span className="block text-sm font-medium text-slate-900 dark:text-white">{user?.name?.split(' ')[0] || 'Administrador'}</span>
